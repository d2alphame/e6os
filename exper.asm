...
STANDARD_HEADER:
    ...
    ; fill these with zeros, we'll fill it in with something that might be more useful.
        .E6_SIGNATURE           db 'E6LOADER'                                                       ; Signature of E6's custom bootloader
        .E6_STARTUP_MESSAGE     db __utf16__ `E6 Custom Bootloader.\r\n\0`
                                times 60-($-STANDARD_HEADER) db 0                                   ; The DOS Headers. Probably not needed by UEFI
...
OPTIONAL_HEADER_START:
    ...
    ; rather than have 40 bytes worth of nothing but zeros, we'll like to put something useful in here.
        ...
        ; --------------------------------------------------------------------
            ...
            ; entries, their space here willbe used for something a little more useful.
            ContinueEntryPoint:
